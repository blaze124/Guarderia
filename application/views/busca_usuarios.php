...
<section class="cuerpo" align="center">
	...
	<?php
		...
		echo form_open('index.php/main_controller/busca_usuarios',$datos);
		...
		if( isset($res) ){
			...
			foreach ($res['0'] as $valor){
				...
				echo'<a href="'.base_url().'index.php/main_controller/mail_tutor/'.$valor['nickname'].'"><img src="'.base_url().'imagenes/logo/ir.png" style="vertical-align: middle; height:25px; width:25px;"></a>';
				echo'<br>';
			}
		}
