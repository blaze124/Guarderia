...
<nav class='navega' align='center'>
	...
	<ul class='menu' >
       ...
       <a href="<?php echo base_url()?>index.php/main_controller/ver_contenido">
		...
		<li class='enlace'>
			<a href='http://facebook.es/guarderia.bahiablanca.1' target='_blank'> <img class='img_pie' src='<?php echo base_url()?>imagenes/logo/face.png' width=20px height=20px></a>
		</li>
		<li class='enlace'>
			<a href='http://escuelainfantileljardindecadiz.blogspot.com.es/' target='_blank'> <img class='img_pie' src='<?php echo base_url()?>imagenes/logo/blog.png' width=20px height=20px></a>
		</li>
		<li class='enlace'>
			<a href='https://twitter.com/CEIBahiaBlanca' target='_blank'> <img class='img_pie' src='<?php echo base_url()?>imagenes/logo/twitter.png' width=20px height=20px></a>
		</li>
    </ul>
