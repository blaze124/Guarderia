...
<nav class='navega' align='center'>
	...
	<ul class='menu' >
        ...
        <a href="<?php echo base_url()?>index.php/mainController/addContenido"><li class='enlace'>Anunciar Cursos</li></a>
        <a href="<?php echo base_url()?>index.php/mainController/incidencias"><li class='enlace'>Incidencias Diarias</li></a>
        <a href="<?php echo base_url()?>index.php/mainController/miCuenta"><li class='enlace'>Mi cuenta</li></a>
        <a href="<?php echo base_url()?>index.php/mainController/cerrarSesion"><li class="enlace">Cerrar Sesión</li></a>
