$(document).ready(function(){
    ...
    $("#calendario .dia").click(function(){
        ...
        //obtenemos el mes a través del campo oculto del formulario
        //y le restamos uno porque en javascript los meses empiezan en 0,
       // si es enero debe ser 0 y no 1
                ...
                "Guardar": function() {       
                    $.ajax({
                        ...
                        success: function(data){            
                            ...
                            setTimeout(function() {
                                window.location.href ="http://localhost/Guarderia/index.php/mainController/incidencias/"+year+"/"+month;
                            }, 2000);
                        }
                    });
                 },
